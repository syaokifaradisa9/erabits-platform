...
import { CheckCircle, XCircle, Wrench, Filter, ChevronDown } from "lucide-react";
...
export default function Show({ inventory, latest_order_number, filter }) {
    const { csrf_token } = usePage().props;
    const [openOrder, setOpenOrder] = useState(latest_order_number);
                                ...
                                <div key={orderGroup.order_number} className="border border-gray-200 dark:border-gray-700 rounded-lg overflow-hidden shadow-sm">
                                    ...
                                    {openOrder === orderGroup.order_number && (
                                        <div className="p-4 space-y-8">
                                            {orderGroup.maintenances.map(maintenance => {
