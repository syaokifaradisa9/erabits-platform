                ...
                <div className="flex items-center justify-between h-16 pl-4 pr-4 mx-auto lg:pl-0 max-w-8xl">
                    <div className="flex items-center gap-4 border-r border-[#00A7A1]/10 w-64">
                        <button
                            ...
                            className="p-1.5 rounded-lg text-slate-600 hover:bg-primary lg:hidden dark:text-slate-400 dark:hover:bg-slate-700/50"
                        >
                            <Menu className="size-6" />
                        </button>
                        {/* <Logo className="hidden h-14 lg:mx-auto sm:flex" /> */}
                    </div>

                    <div className="flex items-center gap-3">
                        <button
                            onClick={toggleTheme}
                            className="p-2 rounded-lg text-primary hover:bg-primary/10 dark:hover:bg-slate-700/50"
                        >
                            {isDark ? (
